...
public class Main {
    public static void main(String[] args) {
        ...
        Vector vector3 = new Vector(new double[]{150, 20});
        Vector vector4 = new Vector(8, new double[]{1, 1, 1, 1, 1, 1, 1, 1});
        Vector vector5 = new Vector(3);

        vector5.add(vector3);
        System.out.println("Прибавление вектора 3 к вектору 5 - " + vector5);
        ...
        System.out.println("Разность векторов 2 и 3 - " + Vector.getSubtraction(vector2, vector3));

        System.out.println("Скалярное умножение векторов 1 и 2 - " + Vector.getScalarMultiplication(vector1, vector2));
